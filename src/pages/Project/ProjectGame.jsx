                    ...
                    <div className="pw-content">
                        ...
                        <div className="eins-modal-text">
                            ...
                            <div className="eins-modal-text-2">
                                <span>Link:</span> <a href="https://TajimaMatsumoto39.github.io/Memorama-main/" target="_blank">https://TajimaMatsumoto39.github.io/Memorama-main/</a>
                            </div>
                ...
                <div className="content-modal">
                    <div className="pw-content">
                        ...
                        <div className="eins-modal-text">
                            ...
                            <div className="eins-modal-text-2">
                                <span>Link:</span> <a href="https://TajimaMatsumoto39.github.io/Ajedrez/" target="_blank">https://TajimaMatsumoto39.github.io/Ajedrez/</a>
                            </div>
                            <div className="eins-modal-text-3">
                                <span>
                                    <FormattedMessage
                ...
                <div className="content-modal">
                    <div className="pw-content">
                        ...
                        <div className="eins-modal-text">
                            ...
                            <div className="eins-modal-text-2">
                                <span>Link:</span> <a href="https://TajimaMatsumoto39.github.io/Game-of-the-Snake-main/" target="_blank">https://TajimaMatsumoto39.github.io/Game-of-the-Snake-main/</a>
                            </div>
                            <div className="eins-modal-text-3">
                                <span>
                                    <FormattedMessage
                ...
                <div className="content-modal">
                    <div className="pw-content">
                        ...
                        <div className="eins-modal-text">
                            ...
                            <div className="eins-modal-text-2">
                                <span>Link:</span> <a href="https://TajimaMatsumoto39.github.io/Questions-and-Answers-main/" target="_blank">https://TajimaMatsumoto39.github.io/Questions-and-Answers-main/</a>
                            </div>
                            <div className="eins-modal-text-3">
                                <span>
                                    <FormattedMessage
