        ...
        <section className="projects__grid paginas-web">
          ...
          <div className="projects__item">
            <a onClick={() => cambiarEstadoModal16(!estadoModal16)}>
              <img src={proyectsImg(`./proyecto-16.PNG`)} className="projects__img" />
            </a>
          </div>
          <div className="projects__item">
          ...
          <div className="pw-content">
            ...
            <div className="eins-modal-text">
              ...
              <div className="eins-modal-text-2">
                <span>Link:</span> <a href="https://TajimaMatsumoto39.github.io/tatoFood/" target="_blank">https://tato-food.com</a>
              </div>
        ...
        <div className="content-modal">
          <div className="pw-content">
            ...
            <div className="eins-modal-text">
              ...
              <div className="eins-modal-text-2">
                <span>Link:</span> <a href="https://TajimaMatsumoto39.github.io/justice-main/" target="_blank">https://justice.com</a>
              </div>
              <div className="eins-modal-text-3">
                <span>
                  <FormattedMessage
        ...
        <div className="content-modal">
          <div className="pw-content">
            ...
            <div className="eins-modal-text">
              ...
              <div className="eins-modal-text-2">
                <span>Link:</span> <a href="https://TajimaMatsumoto39.github.io/magicalEffect/" target="_blank">https://magicaleffect.com</a>
              </div>
              <div className="eins-modal-text-3">
                <span>
                  <FormattedMessage
            ...
            <div className="eins-modal-text">
              <p>
                <FormattedMessage
                  ...
                  defaultMessage='House Sale Store, is an online House sale store.'
                />
              </p>
              <p>
                <FormattedMessage
              ...
              <div className="eins-modal-text-2">
                <span>Link:</span> <a href="https://TajimaMatsumoto39.github.io/bienes/" target="_blank">https://bienes.com/</a>
              </div>
              <div className="eins-modal-text-3">
                <span>
                  <FormattedMessage
        ...
        <div className="content-modal">
          <div className="pw-content">
            ...
            <div className="eins-modal-text">
              ...
              <div className="eins-modal-text-2">
                <span>Link:</span> <a href="https://TajimaMatsumoto39.github.io/inspiredgame/" target="_blank">https://inspired-gamer.com</a>
              </div>
              <div className="eins-modal-text-3">
                <span>
                  <FormattedMessage
        ...
        <div className="content-modal">
          <div className="pw-content">
            ...
            <div className="eins-modal-text">
              ...
              <div className="eins-modal-text-2">
                <span>Link:</span> <a href="https://TajimaMatsumoto39.github.io/everyrunning/" target="_blank">https://every-running.com</a>
              </div>
              <div className="eins-modal-text-3">
                <span>
                  <FormattedMessage
        ...
        <div className="content-modal">
          <div className="pw-content">
            ...
            <div className="eins-modal-text">
              ...
              <div className="eins-modal-text-2">
                <span>Link:</span> <a href="https://TajimaMatsumoto39.github.io/plusanime/" target="_blank">https://plusanime.com</a>
              </div>
              <div className="eins-modal-text-3">
                <span>
                  <FormattedMessage
        ...
        <div className="content-modal">
          <div className="pw-content">
            ...
            <div className="eins-modal-text">
              ...
              <div className="eins-modal-text-2">
                <span>Link:</span> <a href="https://TajimaMatsumoto39.github.io/eleganthand.github.io/" target="_blank">https://elegant-hand.com</a>
              </div>
              <div className="eins-modal-text-3">
                <span>
                  <FormattedMessage
        ...
        <div className="content-modal">
          <div className="pw-content">
            ...
            <div className="eins-modal-text">
              ...
              <div className="eins-modal-text-2">
                <span>Link:</span> <a href="https://TajimaMatsumoto39.github.io/bookstore/" target="_blank">https://vida-en-papel.com</a>
              </div>
              <div className="eins-modal-text-3">
                <span>
                  <FormattedMessage
        ...
        <div className="content-modal">
          <div className="pw-content">
            ...
            <div className="eins-modal-text">
              ...
              <div className="eins-modal-text-2">
                <span>Link:</span> <a href="https://TajimaMatsumoto39.github.io/shoptec/" target="_blank">https://shop-tec.com</a>
              </div>
              <div className="eins-modal-text-3">
                <span>
                  <FormattedMessage
        ...
        <div className="content-modal">
          <div className="pw-content">
            ...
            <div className="eins-modal-text">
              ...
              <div className="eins-modal-text-2">
                <span>Link:</span> <a href="https://TajimaMatsumoto39.github.io/powerengine/" target="_blank">https://power-engine.com</a>
              </div>
              <div className="eins-modal-text-3">
                <span>
                  <FormattedMessage
        ...
        <div className="content-modal">
          <div className="pw-content">
            ...
            <div className="eins-modal-text">
              ...
              <div className="eins-modal-text-2">
                <span>Link:</span> <a href="https://TajimaMatsumoto39.github.io/spiderman/" target="_blank">https://spider-man-fans-page.com</a>
              </div>
              <div className="eins-modal-text-3">
                <span>
                  <FormattedMessage
        ...
        <div className="content-modal">
          <div className="pw-content">
            ...
            <div className="eins-modal-text">
              ...
              <div className="eins-modal-text-2">
                <span>Link:</span> <a href="https://TajimaMatsumoto39.github.io/premierfood/" target="_blank">https://premierfood.com</a>
              </div>
              <div className="eins-modal-text-3">
                <span>
                  <FormattedMessage
        ...
        <div className="content-modal">
          <div className="pw-content">
            ...
            <div className="eins-modal-text">
              ...
              <div className="eins-modal-text-2">
                <span>Link:</span> <a href="https://TajimaMatsumoto39.github.io/blogcoffee/" target="_blank">https://ProgramCoffe.com</a>
              </div>
              <div className="eins-modal-text-3">
                <span>
                  <FormattedMessage
