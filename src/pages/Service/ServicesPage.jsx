        ...
        <div className="row">
            ...
            <div className="columns" data-aos="fade-up" data-aos-delay="400">
                ...
                <p>
                    <FormattedMessage
                        id='marketing-info'
                        defaultMessage="Based on web3.0 and decentralized applications, I will realize client's idea and provide innovative solutions."
                    />
                </p>
            </div>
            <div className="columns" data-aos="fade-up" data-aos-delay="500">
                ...
                <p>
                    <FormattedMessage
                        id='maintenance-info'
                        defaultMessage='I can help businesses harness the power of blockchain technology and smart contracts to drive innovation, improve operational efficiency, and create new revenue streams.'
                    />
                </p>
            </div>
        ...
        <section className="site-services">
          ...
          <div className="row">
            <div className="columns" data-aos="fade-up" data-aos-delay="200">
              ...
              <p className="numero"><span>$</span>300</p>
            ...
            <div className="columns" data-aos="fade-up" data-aos-delay="400">
              ...
              <p className="numero"><span>$</span>1400</p>
              <ul className="ul-cards-services">
                <li>
                  <i className="fas fa-check"></i>
                  <span>
